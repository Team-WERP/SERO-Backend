...
@Tag(name = "Common Code Management", description = "공통코드 관리 API")
@RestController
@RequestMapping("/common-code-manage")
@RequiredArgsConstructor
public class CommonCodeManageQueryController {
    ...
    public ResponseEntity<List<CommonCodeTypeManageDTO>> getAllCodeTypes() {
        List<CommonCodeTypeManageDTO> codeTypes = commonCodeManageQueryService.getAllCodeTypes();
    ...
    public ResponseEntity<List<CommonCodeDetailManageDTO>> getCodeDetailsByType(
        ...
        List<CommonCodeDetailManageDTO> codeDetails = commonCodeManageQueryService.getCodeDetailsByType(typeCode);
