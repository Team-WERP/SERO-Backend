...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "이달의 주문 목표 생성 DTO")
public class SOGoalCreateRequestDTO {
    ...
    public static SOGoalCreateRequestDTO of(SalesOrderGoal goal) {
        return SOGoalCreateRequestDTO.builder()
